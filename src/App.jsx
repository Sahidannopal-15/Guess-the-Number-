...
function reset(){
  ...
  return (
    <main className='flex h-screen bg-gradient-to-r from-black via-gray-900 to-black text-white'>
      <section className='flex-1 flex flex-col items-center mt-8 gap-4'>
        <p className='text-2xl font-extrabold tracking-wide'>🎯Tebak Angka 1-100</p>
        <input type="number" 
        ...
        >
          ...
          <p className='font-bold tracking-wide text-xl text-green-400 drop-shadow-[0_0_10px_rgba(34,197,94,0.8)]'>{result}</p>
          <footer className='mt-28 border-t border-white/10 text-sm italic hover:text-red-500 transition-colors duration-300 tracking-widest'>
            💻 dibuat oleh sahidannopal15
          </footer>
      </section>  
      <div className='flex flex-col bg-gradient-to-b from-red-900 to-rose-800 w-[43%] h-full overflow-y-auto'>
          <p className='text-lg font-semibold mt-8 text-center'>👀 Petunjuk: {hint}</p>
        <ul>
